    ...
    return (
        <React.Fragment>
            ...
            <div className="container">
                <div
                    class="row access justify-content-center align-items-center g-2"
                >
                    <div class="col-md-6 col-12">
                        <form method="POST" className="" onSubmit={(event)=> Logi(event)}>
                            ...
                            <p className="text-center mt-5">Dont have an account? <br /> 
                            Please Sign UP!</p>
                            <div className="form-group">
                                <button type="btn" className="btn btn-danger border-radius-3 add-btn w-100 mt-2" onClick={()=> signup()}><p>Sign UP</p></button>
                            </div>
                        </form>
                    </div>
                </div>
