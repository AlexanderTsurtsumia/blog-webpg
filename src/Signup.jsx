                ...
                >
                    <div class="col-md-6 col-12">
                        ...
                        <div className="form-group">
                            ...
                            <p className="text-center mt-5">Already have an account? <br /> 
                            Please log in!</p>
                            <div className="form-group">
                                <button type="btn" className="btn btn-danger border-radius-3 add-btn w-100 mt-2" onClick={()=> log()}><p>Log In</p></button>
                            </div>
                        </form>
                    </div>
                </div>
